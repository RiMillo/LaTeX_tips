...
\end{verbatim}
  ...
  \item (Not exactly \TeX{}-related) pdf utilities (extract, concatenate, rotate, modify,\ldots): checkout \texttt{pdfjam} (easy stuff like concatenate, rotate, extract) and \texttt{pdftk} (adding background/watermark with option \texttt{background} or \texttt{stamp}).
