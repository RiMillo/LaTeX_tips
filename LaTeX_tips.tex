...
\end{verbatim}
      ...
      \end{itemize}
    \end{itemize}
  \item Dots and abbreviations.
    \begin{itemize}
      \item Suppose you want to write \verb|cf. there|. \LaTeX{} interprets that dot as a phrase-ending period and it stretches the blank between the dot and the following word. Add a tilde, like this \verb|cf.~there| to avoid it, or, equivalently \verb|cf.\ there|, as you would do in math mode.
      \item Conversely, \LaTeX{} interprets a dot after an all-capital word as an abbreviation (e.g.~for John R. R. Tolkien). If it is not the case for you, add \verb|\@| before the period: \verb|Yesterday, I watched Rambo I\@. It is a good movie|.
    \end{itemize}
