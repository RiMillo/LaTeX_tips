...
\end{Verbatim}
    ...
    \item ATTENTION: for big picture it is advised to used the \texttt{TikZ} library \texttt{external} in order to avoid regenerating the picture ad each compilation.
%
  \end{itemize}
  %%%%%%%%%%%%%%%%%%%%%% pgfplots
  ...
  Before going into the details, if you are familiar with \texttt{gnuplot} you may want to check the package \href{http://mirror.ibcp.fr/pub/CTAN/macros/latex/contrib/gnuplottex/gnuplottex.pdf}{\textty{gnuplottex}} out.
